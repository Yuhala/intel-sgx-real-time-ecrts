...
NUM_LOOPS=200000# clean previous results
rm -f *.ct
...
wasm_cyclictest="sudo ./wasm-micro-runtime/product-mini/platforms/linux-sgx/enclave-sample/iwasm --stack-size=1000000 --heap-size=2000000 --max-threads=4 --dir=/ ./cyclictest/cyclic.aot"
